...
def Kalman_traj_smooth(data, process_noise_std, measurement_noise_std):
    ...
    for i in range(1, len(observations)):
        current_state, current_covariance = kf.filter_update(
            smoothed_states[i - 1], kf.initial_state_covariance, observations[i]
        )
...
data = pd.read_csv(r'E:\数据提取\77-109\2\L109.csv', header=None, names=column_names, encoding='utf-8')
...
# 输出
sorted_output_file_path = r'E:\数据提取\77-109\2\xin109.csv'
